...
if ($jabbaVersion -eq "latest")
{
    ...
    $jabbaVersion = (Invoke-RestMethod https://api.github.com/repos/developermibuz/jabba/releases/latest).body
}
...
{
    Invoke-WebRequest https://github.com/developermibuz/jabba/releases/download/$jabbaVersion/jabba-$jabbaVersion-windows-amd64.exe -UseBasicParsing -OutFile $jabbaHome/bin/jabba.exe
}
...
if the problem persists - please create a ticket at https://github.com/developermibuz/jabba/issues.
"@
    exit 1
}
...
(if you have any problems please report them at https://github.com/developermibuz/jabba/issues)
"@
