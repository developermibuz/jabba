...
curl -sL https://github.com/developermibuz/jabba/raw/master/install.sh | bash && . ~/.jabba/jabba.sh
```
...
```sh
export JABBA_VERSION=...
curl -sL https://github.com/developermibuz/jabba/raw/master/install.sh | bash -s -- --skip-rc && . ~/.jabba/jabba.sh
```
...
> export JABBA_VERSION=...
`curl -sL https://github.com/developermibuz/jabba/raw/master/install.sh | bash; and . ~/.jabba/jabba.fish` 
...
RUN curl -sL https://github.com/developermibuz/jabba/raw/master/install.sh | \
...
Invoke-Expression (
  Invoke-WebRequest https://github.com/developermibuz/jabba/raw/master/install.ps1 -UseBasicParsing
).Content
```
...
```sh
git clone https://github.com/developermibuz/jabba $GOPATH/src/github.com/developermibuz/jabba 
cd $GOPATH/src/github.com/developermibuz/jabba 
make fetch
